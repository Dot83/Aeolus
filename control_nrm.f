...
!      print*,'be careful! P=P+1 at control.f!'
...
!bracket the observations at the corresponding model phases
  !    DO i=1,nel
!       call  brack(tin(i),tguess,lim,ndata,i1,i2)
...
!      print*,i,tin(i),i1,i2
 ...
 !      print*,tup(i),fup(i)
      ...
      ENDDO
       ...
       DO i=1,N
        chi2x=chi2x+(xguess(i)-fup(i))**2./sigmain(i)**2.
       ENDDO
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ repeat for the other model
      ...
      ENDDO
       ...
       DO i=1,N
        chi2xn=chi2xn+(xn(i)-fup(i))**2./sigmain(i)**2.
       ENDDO
